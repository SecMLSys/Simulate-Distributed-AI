...
# DATA_DIR = '../health_data/new_data/'
# HEALTH_PATH = DATA_DIR + 'total_health_data.csv'

# DATA_DIR = '../health_data/new-data/'
# HEALTH_PATH = DATA_DIR + 'total_health_data.csv'
...
def load_health(attr='age', train_size=0.8, random_seed=0,
    ...
    # print(y_train.max(), s_train[0:10])
